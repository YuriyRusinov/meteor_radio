...
meteorRadioController::meteorRadioController( double messSpeed, const QVector< QSharedPointer< meteorRadioStation > >& mStations, QSharedPointer< int > messCounter, QSharedPointer< int > allCounter, QObject* parent )
    : QObject( parent ),
